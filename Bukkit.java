...
public final class Bukkit {
    ...
    public static void setServer(Server server) {
        ...
        Bukkit.server = server;
        PaperBullet.LOGGER.info("This server is running " + getName() + " version " + getVersion() + " (Implementing API version " + getBukkitVersion() + ")");
    }
